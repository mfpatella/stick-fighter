...
const characterSheetConfigs: Record<SheetFighterKey, CharacterSheetConfig> = {
  ...
  marthaStewart: {
    ...
    kick: { frames: [24, 25, 26, 27, 28, 31] },
    spinKick: { frames: [24, 25, 26, 27, 28, 31] },
    low: { frames: [24, 25, 26, 27, 28, 31] },
  ...
  slimer: {
    ...
    low: { frames: [32, 33] },
    kick: { frames: [16] },
    blockedFrames: [1, 2, 3, 4, 5, 7, 15, 17, 19, 20, 21, 23, 25, 26, 27, 29, 30, 31, 34, 39, 41, 42, 43, 44, 46, 47],
    scale: 1.02,
    baseBodyScale: 0.9,
    originX: 0.5,
    originY: 0.78,
